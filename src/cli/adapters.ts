...
7. **Recommendations** — Suggest relevant features: CI → mem-auto-review, multiple contributors → Full tier, no tests → testing-strategy pattern, monorepo → per-package skills.
