...
- **Slug scheme change:** frames written with legacy base64url slugs before this task will not collide with new `h.{hex}` slugs; no migration of old pages attempted.
