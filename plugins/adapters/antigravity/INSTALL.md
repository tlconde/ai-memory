# Antigravity — Post-install steps

1. Add ai-memory MCP to your global config: `~/.gemini/antigravity/mcp_config.json` (or `%APPDATA%\antigravity\mcp_config.json` on Windows). Antigravity uses global MCP config only.
